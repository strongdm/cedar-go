...
var extFuncTypes = map[types.Path]extFuncSig{
	// Constructors
	"ip":       {argTypes: []cedarType{typeString{}}, returnType: typeExtension{"ipaddr"}},
	"decimal":  {argTypes: []cedarType{typeString{}}, returnType: typeExtension{"decimal"}},
	"datetime": {argTypes: []cedarType{typeString{}}, returnType: typeExtension{"datetime"}},
	"duration": {argTypes: []cedarType{typeString{}}, returnType: typeExtension{"duration"}},
